...
namespace Home.WebApi.UseCases.Calendar.GetCalendarEvent;

/// <summary>
/// An event as stored, rule and all, which is what the editor needs. Occurrences come from the
/// calendar read instead.
/// </summary>
public class GetCalendarEventApiResponse
{

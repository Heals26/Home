...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20250907040935_AddAuthenticationMetadata")]
    partial class AddAuthenticationMetadata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOnUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 9, 7, 4, 9, 35, 512, DateTimeKind.Utc).AddTicks(3916));

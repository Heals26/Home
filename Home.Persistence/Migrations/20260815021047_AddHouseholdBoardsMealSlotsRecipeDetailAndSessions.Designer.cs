...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20260815021047_AddHouseholdBoardsMealSlotsRecipeDetailAndSessions")]
    partial class AddHouseholdBoardsMealSlotsRecipeDetailAndSessions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOnUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 8, 15, 2, 10, 47, 390, DateTimeKind.Utc).AddTicks(4811));

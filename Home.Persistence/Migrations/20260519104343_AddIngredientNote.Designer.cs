...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20260519104343_AddIngredientNote")]
    partial class AddIngredientNote
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOnUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 5, 19, 10, 43, 42, 443, DateTimeKind.Utc).AddTicks(7419));

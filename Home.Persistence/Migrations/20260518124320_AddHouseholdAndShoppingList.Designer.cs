...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20260518124320_AddHouseholdAndShoppingList")]
    partial class AddHouseholdAndShoppingList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOnUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 5, 18, 12, 43, 19, 936, DateTimeKind.Utc).AddTicks(9574));

...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20260815033831_FixRecipeStepAndAuditRelationships")]
    partial class FixRecipeStepAndAuditRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOnUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 8, 15, 3, 38, 30, 668, DateTimeKind.Utc).AddTicks(9131));

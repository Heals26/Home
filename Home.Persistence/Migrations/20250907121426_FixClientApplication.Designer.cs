...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20250907121426_FixClientApplication")]
    partial class FixClientApplication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOnUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 9, 7, 12, 14, 25, 873, DateTimeKind.Utc).AddTicks(4692));

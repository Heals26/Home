...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20260916081945_ShoppingTrips")]
    partial class ShoppingTrips
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Home.Domain.Entities.ShoppingCategory", b =>
                {
                    b.Property<long>("ShoppingCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Home.Domain.Entities.ShoppingItemMemory", b =>
                {
                    b.Property<long>("ShoppingItemMemoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ShoppingItemMemoryID"));
                    ...
                    b.ToTable("ShoppingItemMemory", "home");
                });

            modelBuilder.Entity("Home.Domain.Entities.ShoppingItemPrice", b =>
                {
                    b.Property<long>("ShoppingItemPriceID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ShoppingItemPriceID"));

                    b.Property<decimal?>("Amount")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<DateTime>("BoughtOnUTC")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("ShoppingItemPriceID");

                    b.HasIndex("ShoppingItemMemoryID", "BoughtOnUTC");

                    b.HasIndex("ShoppingListItemID", "ShoppingTripID");

                    b.ToTable("ShoppingItemPrice", "home");
                });
            ...
            modelBuilder.Entity("Home.Domain.Entities.ShoppingTrip", b =>
                {
                    b.Property<long>("ShoppingTripID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ShoppingTripID"));
                    ...
                    b.HasIndex("ShoppingListID", "EndedOnUTC");

                    b.ToTable("ShoppingTrip", "home");
                });
            ...
            modelBuilder.Entity("Home.Domain.Entities.Activity", b =>
                {
                    b.HasOne("Home.Domain.Entities.User", "CompletedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Home.Domain.Entities.ShoppingItemMemory", b =>
                {
                    b.HasOne("Home.Domain.Entities.Household", "Household")
                        .WithMany("ShoppingItemMemories")
                        .HasForeignKey("HouseholdID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ShoppingItemMemory_Household");

                    b.HasOne("Home.Domain.Entities.ShoppingCategory", "ShoppingCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Home.Domain.Entities.ShoppingItemPrice", b =>
                {
                    b.HasOne("Home.Domain.Entities.ShoppingItemMemory", "Memory")
                        .WithMany("Prices")
            ...
            modelBuilder.Entity("Home.Domain.Entities.Household", b =>
                {
                    ...
                    b.Navigation("ShoppingCategories");

                    b.Navigation("ShoppingItemMemories");

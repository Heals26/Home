...
namespace Home.Persistence.Migrations
{
    ...
    [Migration("20260814110221_AddMealPlanAnnouncementsAndSunSchedules")]
    partial class AddMealPlanAnnouncementsAndSunSchedules
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOnUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 8, 14, 11, 2, 20, 425, DateTimeKind.Utc).AddTicks(2714));
